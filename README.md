...
local Item = PepsiUi:CreateTab({
    Name = "Item"
})

local Cb = PepsiUi:CreateTab({
    Name = "Combat"
})
local Tp = PepsiUi:CreateTab({
    Name = "Teleport"
})
local Misc = PepsiUi:CreateTab({
    Name = "Misc"
})


local Tab = Page:CreateSection({
    Name = "Farm", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Tab2 = Page:CreateSection({
    Name = "SettingFarm", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})

local Tab1 = Page:CreateSection({
    Name = "Misc Player", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})

local Tab4 = Page:CreateSection({
    Name = "Fruit", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Tab5 = Page:CreateSection({
    Name = "Combat", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Tab6 = Page:CreateSection({
    Name = "Boss", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Tem1 = Page:CreateSection({
    Name = "Abilities", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})


local Tem = Item:CreateSection({
    Name = "Buy Melee", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local SwordShopSection = Item:CreateSection({
	Name = "Sword Shop",
	Side = "Left"
})
local GunShopSection = Item:CreateSection({
	Name = "Gun Shop",
	Side = "Right"
})

local RacefragmentSection = Item:CreateSection({
	Name = "Race&Fragment Shop",
	Side = "Right"
})


local Cb1 = Cb:CreateSection({
	Name = "aim bot",
	Side = "Right"
})
local Cb2 = Cb:CreateSection({
	Name = "Farm Bounty",
	Side = "Left"
})
local Teleport = Tp:CreateSection({
    Name = "Teleport", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Teleport1 = Tp:CreateSection({
    Name = "Fast Teleport World3", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
local Teleport2 = Tp:CreateSection({
    Name = "Teleport World", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Teleport3 = Tp:CreateSection({
    Name = "Hop & rejoin", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})

local Msc1 = Misc:CreateSection({
    Name = "Join Team", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Msc2 = Misc:CreateSection({
    Name = "Open Menu", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local Msc = Misc:CreateSection({
    Name = "Misc", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})


Tab:AddLabel("///// Time Game /////")

GameTime = Tab:AddLabel("")
GameTime1 = Tab:AddLabel("")
GameTime2 = Tab:AddLabel("")

spawn(function()
	while task.wait() do
	_G.GameTime = math.floor(workspace.DistributedGameTime+0.5)
		GameTime:Set("Hour : "..math.floor(_G.GameTime/(60^2))%24)
		GameTime1:Set("Minute	: "..math.floor(_G.GameTime/(60^1))%60)
		GameTime2:Set("Minute	: "..math.floor(_G.GameTime/(60^0))%60)
	end
end)
		


Tab:AddLabel("///// Ping/Fps /////")
...
spawn(function()
	while task.wait() do
		Fps:Set("Fps : "..workspace:GetRealPhysicsFPS())
	end
end)
...
StatusAutoFarm = Tab:AddLabel('AutoFarm : ❌')
...
task.spawn(
    function()
        pcall(
            function()
                while wait() do
                    if getgenv().Config.autofarmlevel == false then
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                        StatusAutoFarm:Set("AutoFarm : ❌")
                    elseif getgenv().Config.autofarmlevel == true then
                        StatusAutoFarm:Set("AutoFarm : ✅")
                    end
                end
            end
...
Tab:AddToggle({
    Name = "Auto Farm",
	Value = getgenv().Config.autofarmlevel, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab:AddToggle({
    Name = "Auto New world",
	Value = getgenv().Config.autonewworld, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
spawn(function()
	while wait() do
		if getgenv().Config.autonewworld then
			...
			if MyLevel >= 700 and World1 and World2 then
...
DevilFruit = Tab1:AddLabel("")



spawn(function()
	DevilFruit:Set("DevilFruit : "..game:GetService("Players").LocalPlayer.Data.DevilFruit.Value)
end)
...
Fragments = Tab1:AddLabel("")



spawn(function()
	Fragments:Set("Fragment : "..game:GetService("Players").LocalPlayer.Data.Fragments.Value)
end)
...
spawn(function()
	while task.wait() do
		...
		Melee:Set("MeleeLV : "..game:GetService("Players").LocalPlayer.Data.Stats.Melee.Level.Value)
	end
end)

Defense = Tab1:AddLabel("")


spawn(function()
	while task.wait() do

		Defense:Set("DefenseLv : "..game:GetService("Players").LocalPlayer.Data.Stats.Defense.Level.Value)
	end
end)
...
spawn(function()
	while task.wait() do
		...
		Sword:Set("SwordLv : "..game:GetService("Players").LocalPlayer.Data.Stats.Sword.Level.Value)
	end
end)
...
spawn(function()
	while task.wait() do
		...
		Gun:Set("GunLv : "..game:GetService("Players").LocalPlayer.Data.Stats.Gun.Level.Value)
	end
end)
...
DemonFruit = Tab1:AddLabel("")


spawn(function()
	while task.wait() do

		DemonFruit:Set("DemonFruitLv : "..game:GetService("Players").LocalPlayer.Data.Stats["Demon Fruit"].Level.Value)
	end
end)
...
Tab1:AddLabel("///// Auto Stats /////")


Tab1:AddToggle({
    Name = "Kaitun Stat",
	Value = getgenv().Fullystats, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab1:AddToggle({
    Name = "Melee",
	Value = getgenv().melee, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      getgenv().melee = x
    end
})
...
Tab1:AddToggle({
    Name = "Defense",
	Value = getgenv().defense, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      getgenv().defense = x
    end
})
...
Tab1:AddToggle({
    Name = "Sword",
	Value = getgenv().sword, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      getgenv().sword = x
    end
})
...
Tab1:AddToggle({
    Name = "Gun",
	Value = getgenv().gun, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      getgenv().gun = x
    end
})
...
Tab1:AddToggle({
    Name = "Blox Fruit",
	Value = getgenv().df, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      getgenv().df = x
    end
})
...
Tab2:AddDropdown({
	Name = "Select Weapon",
	Value = "Melee", -- ค่าที่จะให้มันเลือก
	List = Wap,
	MultiSelect = false,
	Callback = function(x)
...
Tab2:AddToggle({
    Name = "Fast Attack",
	Value = getgenv().Config.fastattack, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab2:AddToggle({
    ...
    Value = getgenv().Config.RemoveAnimation, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
        getgenv().Config.RemoveAnimation = x
...
Tab2:AddToggle({
    Name = "Camera Shaker",
	Value = getgenv().Config.CameraShaker, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
		getgenv().Config.CameraShaker = x
    end
})

Tab2:AddToggle({
    Name = "Auto Buso",
	Value = getgenv().Config.buso, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab2:AddToggle({
    Name = "Auto Ken",
	Value = getgenv().Config.ken, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab2:AddToggle({
    Name = "Remove Effect",
	Value = getgenv().Config.remove_effect, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab2:AddToggle({
    Name = "Lock Fps Kaitun",
	Value = _G.Kaitunfps, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      _G.Kaitunfps = x
local RunService = game:GetService("RunService")
local MaxFPS = 8
while _G.Kaitunfps do
    local t0 = tick()
...
Tab4:AddToggle({
	...
	Value = RandomFruit, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      RandomFruit = x
    end
})
...
Tab4:AddToggle({
	...
	Value = _G.AutoRaidStoreFruit, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
      _G.StoreFruit = x
    end
})
...
Tab4:AddToggle({
    Name = "Bing Fruit",
	Value = _G.CollectFruit, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
       _G.CollectFruit = x
    end
})
  ...
  Tab6:AddDropdown({
	  Name = "Select Boss",
	  Value = "Select Boss", -- ค่าที่จะให้มันเลือก
	  List = Boss,
	  MultiSelect = false,
	  Callback = function(v)
		SelectBoos = v
  ...
  Tab6:AddToggle({
    Name = "Auto Farm",
	Value = getgenv().Config.boss, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
		getgenv().Config.boss = x
      _TweenCanCle(getgenv().Config.boss)
    end
})
  ...
  spawn(function()
	  while wait() do
		  if getgenv().Config.boss then
			if getgenv().Config.boss == true then
				UseFast = true
			end
			if getgenv().Config.boss == false then
				UseFast = false
			end
			equip(getgenv().Config.selectweapon)
			  ...
			  until not getgenv().Config.boss or v.Humanoid.Health <= 0
				  else
					  if game:GetService("ReplicatedStorage"):FindFirstChild(SelectBoos) then
						two(game:GetService("ReplicatedStorage"):FindFirstChild(SelectBoos).HumanoidRootPart.CFrame)
  ...
  Tab5:AddToggle({
	...
	Value = getgenv().automelee.superhuman, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
...
Tab5:Toggle({
	...
	Value = _G.FightingStyleAutoElectricClaw,
	callback = function(value)
		_G.FightingStyleAutoElectricClaw = value
		if _G.FightingStyleAutoElectricClaw then
			Com("F_","BuyElectro")
		end
		task.spawn(function()
			while wait() do
  ...
  Tab5:AddToggle({
    Name = "Auto Godhuman",
	Value = getgenv().Config.AutoFullyGodhuman, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
		getgenv().Config.AutoFullyGodhuman = x
    end
})
...
spawn(function()
	while wait() do
		if getgenv().Config.AutoFullyGodhuman then
			pcall(function()
			if game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
				getgenv().Config.selectweapon = "Godhuman"
				else
                  	  	...
                  	  	if v.Name == "Fishman Raider [Lv. 1775]" or v.Name == "Fishman Captain [Lv. 1800]" then
                        		if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                           	 	repeat task.wait()
                                		...
                                		game:GetService'VirtualUser':CaptureController()
                                		game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                            		until not getgenv().Config.AutoFullyGodhuman or not v.Parent or v.Humanoid.Health <= 0
                        		end
                  				else
									_groupMon = false
...
RacefragmentSection:AddButton({
	...
	Callback = function()
		...
		Circle.Color =  Color3.fromRGB(223, 255, 0)
		Circle.Thickness = 1
		Circle.Radius = 250
		Circle.NumSides = 460
		Circle.Filled = false
		...
		Cb1:AddToggle({
			Name = "Show Fov",
			Value = _G.Show_Fov, -- ปรับค่าToggle true/false or Config
			Callback = function(value)
				_G.Show_Fov = value
			end
		})
		...
		Cb1:AddToggle({
			...
			Value = _G.Aimbot_Skill_Fov, -- ปรับค่าToggle true/false or Config
			Callback = function(value)
		...
		Cb1:AddToggle({
			...
			Value = _G.Aimbot_Skill_Near, -- ปรับค่าToggle true/false or Config
			Callback = function(value)
		...
		Cb2:AddToggle{
			...
			Callback  = function(value)
					...
					_TweenCanCle(_G.Teleport_to_Player)
			end
		}
		...
		spawn(function()
			while wait() do
			if _G.Teleport_to_Player == true then
			pcall(function()
				TP(game.Players[_G.Select_Player].Character.HumanoidRootPart.CFrame * CFrame.new(0,10,0))
			end)
			end
			end
			end)
  ...
  Teleport:AddDropdown({
	Name = "Select Place",
	Value = "Select", -- ค่าที่จะให้มันเลือก
	List = Island,
	MultiSelect = false,
	Callback = function(x)
     SelectedIsland = x
...
StatusTp = Teleport:AddLabel('Teleporting : ❌')
...
task.spawn(
  ...
  Teleport:AddToggle({
    Name = "Tween to Place",
	Value = _statetp, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
		Teleporting = x
        _statetp = x
             if _statetp then
...
Tem1:AddToggle({
    Name = "Auto Buy all Abilities",
	Value = _G.AllEnchant, -- ปรับค่าToggle true/false or Config
...
Msc:AddToggle({
    Name = "White Screen",
	Value = _G.WhiteScreen, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
...
Msc:AddToggle({
    Name = "Inf All Ability",
	Value = _G.AllAbility, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
		InfAbility = x
		end
})
...
Msc:AddToggle({
    Name = "White Screen",
	Value = _G.InfinitiesEnergy, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
...
Msc:AddToggle({
    Name = "Walk on water",
	Value = _G.Walkon, -- ปรับค่าToggle true/false or Config
    Callback = function(x)
_G.Walkon = x
while _G.Walkon do wait()
  ...
  function checklevel()
      ...
      if world1 then
          ...
          CFramePuk = CFrame.new(1065.08545, 16.2736015, 1633.85449, -0.897475779, 6.70613565e-11, -0.441063732, 2.45463161e-09, 1, -4.84263563e-09, 0.441063732, -5.42879741e-09, -0.897475779)
          ...
          CFramePuk = CFrame.new(-1535.58179, 15.8521042, 240.979187, 0.949857235, -1.177707e-08, 0.31268388, 2.84077988e-08, 1, -4.86314917e-08, -0.31268388, 5.50756347e-08, 0.949857235)
          ...
          NameQ = "Gorilla"
          CFrameQ = CFrame.new(-1600.24353, 36.8521347, 153.224792, 0.0664860159, 1.09421023e-07, -0.997787356, 9.55680779e-09, 1, 1.10300476e-07, 0.997787356, -1.68691017e-08, 0.0664860159)
          CFramePuk = CFrame.new(-1267.53992, 11.2199373, -660.336975, -0.52836895, -5.27201216e-08, 0.849014878, 1.13397247e-08, 1, 6.9152712e-08, -0.849014878, 4.61657379e-08, -0.52836895)
             ...
             elseif MYLEVEL == 2100 or MYLEVEL <= 2124 then
              ...
              elseif MYLEVEL == 2250 or MYLEVEL <= 2274 then
				...
				elseif MYLEVEL == 2300 or MYLEVEL <= 2324 then
					...
					QuestLv = 1
					NameQ = "Cocoa Warrior"
					CFrameQ = CFrame.new(230.585785, 25.0774899, -12196.6836, 0.868978918, 3.36803474e-09, -0.494849116, -3.90183663e-09, 1, -4.56285149e-11, 0.494849116, 1.97047068e-09, 0.868978918)
					CFramePuk = CFrame.new(49.4270325, 43.4510956, -12292.5576, -0.517707348, -1.51210582e-08, 0.85555774, -7.49705293e-08, 1, -2.76915664e-08, -0.85555774, -7.8477747e-08, -0.517707348)
				elseif MYLEVEL == 2325 or MYLEVEL <= 2349 then
					...
					CFrameQ = CFrame.new(230.585785, 25.0774899, -12196.6836, 0.868978918, 3.36803474e-09, -0.494849116, -3.90183663e-09, 1, -4.56285149e-11, 0.494849116, 1.97047068e-09, 0.868978918)
					CFramePuk = CFrame.new(645.341614, 42.6226158, -12410.0371, 0.717433393, -2.67781153e-09, 0.69662714, 5.97059602e-09, 1, -2.30495378e-09, -0.69662714, 5.81292969e-09, 0.717433393)
				elseif MYLEVEL == 2350 or MYLEVEL <= 2374 then
					Ms = "Sweet Thief [Lv. 2350]"
					NameQuest = "ChocQuest2" 
					QuestLv = 1
					NameQ = "Sweet Thief"
					CFrameQ = CFrame.new(149.377655, 25.1370754, -12774.6309, -0.970706761, 5.05650188e-10, 0.240267336, 2.20934493e-10, 1, -1.21193156e-09, -0.240267336, -1.12334675e-09, -0.970706761)
					CFramePuk = CFrame.new(-39.2877808, 58.0547333, -12854.7061, 0.681667507, -3.05135295e-08, 0.731662095, -4.7095174e-08, 1, 8.55815543e-08, -0.731662095, -9.2795915e-08, 0.681667507)
				elseif MYLEVEL >= 2375 then
					...
					NameQ = "Candy Rebel"
					CFrameQ = CFrame.new(149.377655, 25.1370754, -12774.6309, -0.970706761, 5.05650188e-10, 0.240267336, 2.20934493e-10, 1, -1.21193156e-09, -0.240267336, -1.12334675e-09, -0.970706761)
					CFramePuk = CFrame.new(-65.5990219, 47.4652519, -12874.1494, -0.894532204, -7.05132785e-10, 0.447003543, -2.48384069e-09, 1, -3.39313377e-09, -0.447003543, -4.14555279e-09, -0.894532204)
              end
      end
  end
...
spawn(function()
    while true do wait()
        getgenv().rejoin = game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(Kick)
            if not _G.TP_Ser and _G.RejoinEr then
